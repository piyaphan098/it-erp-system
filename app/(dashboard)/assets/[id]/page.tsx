import { updateAsset, deleteAsset } from "../action";
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="flex items-center space-x-4">
        ...
        {session?.user?.role === "ADMIN" && (
          <form action={deleteAssetWithId} className="ml-auto">
            <button
      ...
      <form action={updateAssetWithId} className="bg-white dark:bg-gray-800 shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
